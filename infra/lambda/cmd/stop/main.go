// Command stop is the Lambda that powers the scheduled EC2 instance off.
// It is invoked by the "stop" EventBridge schedule; all of its behaviour lives
...
func main() {
	...
	lambda.Start(func(ctx context.Context, _ json.RawMessage) (ec2sched.Result, error) {
		return ec2sched.Handle(ctx, ec2sched.Stop)
	})
}
